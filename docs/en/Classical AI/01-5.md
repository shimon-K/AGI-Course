...
- <h4>See the beauty of connecting seperate topics: system dynamics from control theory as deterministic and Markov chains as stochastic and causality as Bayesian networks and Do operations. In all these we present system without and with intervention.</h4>

...
- Another argument in Expectance is: $E[g(Y)\|X]=E[X]$, also referred to as _“Law of total expectation”_. Also: $E[X] = \sum_\limits_{y} \underbrace{E[X\|Y=y]}_\text{g(Y)}P(Y=y) = E[g(Y)] = E[E[X\|Y]] $,   and $E[h(X)Y\|X] = h(X)E[Y\|X]$.

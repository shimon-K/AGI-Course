...
- If $A\perp B$ then also their completing counterparts and their combinations are also independent: $\widebar{A}\perp B$ ; $A\perp \widebar{B}$ ; $\widebar{A}\perp \widebar{B}$. 

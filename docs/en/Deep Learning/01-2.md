...
1. [Background Math for AI](https://shimon-k.github.io/AGI-Course/en/Deep%20Learning/01-2#Background Math for AI)
...
<a id="Background Math for AI"> </a>
## Background Math for AI  + Interactive exercises
...
<iframe
  src="{{ site.baseurl }}/en/Deep%20Learning/quizzes/youtube-quiz-a.html"
  width="100%" height="395"
  style="border:1px solid #2a2a2a; border-radius:4px;"
  allowfullscreen
></iframe>

### Math for AI - Optimization
<iframe
  src="{{ site.baseurl }}/en/Deep%20Learning/quizzes/youtube-quiz-b.html"
  width="100%" height="395"
  style="border:1px solid #2a2a2a; border-radius:4px;"
  allowfullscreen
></iframe>

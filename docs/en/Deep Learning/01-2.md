...
1. [Math for AI - Linear Algebra](https://shimon-k.github.io/AGI-Course/en/Deep%20Learning/01-2#Math for AI - Linear Algebra)
...
<a id="Math for AI - Linear Algebra"> </a>
### Math for AI - Linear Algebra + Interactive exercises
